...
export const SCHEDULE = {
    thursday: {
        ...
        matches: [
            ...
            { num: '2경기', round: '예선', category: '남자 중등', match: '미결정' },
            { num: '3경기', round: '결선', category: '여자 연합', match: '문경 VS 음성' },
            { num: '4경기', round: '결선', category: '남자 중등', match: '부전승팀 VS 예선 승리 팀' },
            { num: '5경기', round: '결선', category: '남자 고등', match: '세종 VS 예선 승리 팀' },
        ],
    },
    friday: {
        key: 'friday',
        ...
        emoji: '🏐',
        matches: [
            { num: '1경기', round: '예선', category: '여자 연합', match: '음성 VS 세종' },
            { num: '2경기', round: '예선', category: '남자 중등', match: '문경 VS 음성' },
            { num: '3경기', round: '예선', category: '남자 고등', match: '문경 VS 음성' },
            { num: '4경기', round: '결선', category: '여자 연합', match: '문경 VS 예선 승리 팀' },
            { num: '5경기', round: '결선', category: '남자 중등', match: '세종 VS 예선 승리 팀' },
