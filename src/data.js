...
export const SCHEDULE = {
    thursday: {
        ...
        matches: [
            ...
            { num: '1경기', round: '예선', category: '남자 중등', match: '부전승 미결정' },
    ...
    friday: {
        ...
        emoji: '🏐',
        matches: [
            { num: '2경기', round: '예선', category: '여자 연합', match: '음성 VS 세종' },
            { num: '1경기', round: '예선', category: '남자 중등', match: '문경 VS 음성' },
            { num: '3경기', round: '예선', category: '남자 고등', match: '문경 VS 음성' },
            { num: '5경기', round: '결선', category: '여자 연합', match: '문경 VS 예선 승리 팀' },
            { num: '4경기', round: '결선', category: '남자 중등', match: '세종 VS 예선 승리 팀' },
            { num: '6경기', round: '결선', category: '남자 고등', match: '세종 VS 예선 승리 팀' },
        ],
    },
    saturday: {
        key: 'saturday',
        ...
        venues: [
            {
                ...
                items: [
                    ...
                    { start: '11:40', end: '12:30', round: '예선', label: '축구 남고부', sub: '음성 VS 세종', meta: '50분' },
                    { start: '12:30', end: '13:20', round: '결선', label: '축구 남중부', sub: '음성 VS 문경', meta: '50분' },
                    { start: '13:20', end: '14:00', round: '결선', label: '축구 여자연합', sub: '음성 VS 문경', meta: '40분' },
                    {
                        start: '14:00',
                        end: '14:50',
                        round: '결선',
            ...
            },
            {
                ...
                items: [
                    ...
                    { start: '11:45', end: '12:05', round: '결선', label: '겨루기 여자', sub: '문경 VS 음성', meta: '20분' },
                    { start: '12:05', end: '12:25', round: '결선', label: '겨루기 남자', sub: '문경 VS 음성', meta: '20분' },
                ],
            },
            {
