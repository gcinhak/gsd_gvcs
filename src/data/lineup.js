    ...
    문경: {
        ...
        축구: {
            남중: [
                ...
                { no: 13, grade: 9, name: '류제이' },
                { no: 14, grade: 9, name: '박서준' },
            ],
            남고: [
        ...
        태권도: {
            태권체조: [
                ...
                { no: 7, grade: 9, name: '변지원' },
            ],
            '품새(중)': [
                { no: 1, grade: 9, name: '이정우' },
                { no: 2, grade: 8, name: '조민수' },
            ],
            '품새(고)': [
                { no: 1, grade: 11, name: '이지율' },
                { no: 2, grade: 12, name: '심예진' },
            ],
            '겨루기(남)': [
                { no: 1, grade: 11, name: '운유송' },
                { no: 2, grade: 12, name: '이건희' },
                { no: 3, grade: 12, name: '조승운' },
                { no: 4, grade: 12, name: '최종민' },
            ],
            '겨루기(여)': [
        ...
        탁구: {
            중등부: [
                { no: 1, grade: 9, name: '변채영', alt: '여' },
                { no: 2, grade: 9, name: '조시온', alt: '여' },
                { no: 3, grade: 9, name: '홍하일', alt: '남' },
                { no: 4, grade: 9, name: '백종서', alt: '남' },
            ],
            고등부: [
                { no: 1, grade: 11, name: '김은혜F', alt: '여' },
                { no: 2, grade: 12, name: '이윤지', alt: '여' },
                { no: 3, grade: 10, name: '이명준', alt: '남' },
                { no: 4, grade: 10, name: '홍승현', alt: '남' },
            ],
            인기모: [
                { no: 1, name: '홍하일(부)' },
                { no: 2, name: '최규민(부)' },
        ...
        이어달리기: {
            통합: [
                { label: '12학년' },
                { no: 1, grade: 12, name: '강민성', alt: '남', role: '학생' },
                { no: 2, grade: 12, name: '김세빈', alt: '여', role: '학생' },
                { label: '11학년' },
                { no: 3, grade: 11, name: '박주영', alt: '남', role: '학생' },
                { no: 4, grade: 11, name: '이예찬', alt: '여', role: '학생' },
                { label: '10학년' },
                { no: 5, grade: 10, name: '배혜성', alt: '남', role: '학생' },
                { no: 6, grade: 10, name: '임환희', alt: '여', role: '학생' },
                { label: '9학년' },
                { no: 7, grade: 9, name: '김유현', alt: '남', role: '학생' },
                { no: 8, grade: 9, name: '이래윤', alt: '여', role: '학생' },
                { label: '8학년' },
                { no: 9, grade: 8, name: '김세윤', alt: '남', role: '학생' },
                { no: 10, grade: 8, name: '최민교', alt: '여', role: '학생' },
                { label: '7학년' },
                { no: 11, grade: 7, name: '김지후', alt: '남', role: '학생' },
                { no: 12, grade: 7, name: '주혜원', alt: '여', role: '학생' },
                { label: '인기모' },
                { no: 13, name: '박하은(부)', alt: '남', role: '인기모' },
                { no: 14, name: '강윤성(모)', alt: '여', role: '인기모' },
                { label: '교직원' },
                { no: 15, name: '파이샬', alt: '남', role: '교직원' },
                { no: 16, name: '이나은', alt: '여', role: '교직원' },
                { label: '동문' },
                { no: 17, name: '김무빈', alt: '남', role: '동문' },
                { no: 18, name: '진태연', alt: '여', role: '동문' },
            ],
        },
    ...
    음성: {
        ...
        축구: {
            여연합: [
                ...
                { no: 3, grade: 9, name: '공예은' },
                { no: 4, grade: 9, name: '손유항' },
                { no: 5, grade: 10, name: '박다현' },
                { no: 6, grade: 10, name: '이유림' },
                { no: 7, grade: 10, name: '임지윤' },
                { no: 8, grade: 11, name: '허윤성' },
                { no: 9, grade: 12, name: '강수연' },
                { no: 10, grade: 12, name: '이희나' },
                { no: 11, grade: 12, name: '조수아' },
                { no: 12, grade: 7, name: '장윤서' },
                { no: 13, grade: 9, name: '이여랑' },
                { no: 14, grade: 10, name: '김효은' },
                { no: 15, grade: 10, name: '송민진' },
                { no: 16, grade: 11, name: '김주원' },
            ],
            남고: [
                { no: 1, grade: 12, name: '장동혁' },
                { no: 2, grade: 12, name: '이원혁' },
                { no: 3, grade: 12, name: '김준수' },
                { no: 4, grade: 12, name: '박원홍' },
                { no: 5, grade: 12, name: '김종연' },
                { no: 6, grade: 12, name: '이예준' },
                { no: 7, grade: 11, name: '구명준' },
                { no: 8, grade: 11, name: '이정운' },
                { no: 9, grade: 11, name: '임한날' },
                { no: 10, grade: 11, name: '김영빈' },
                { no: 11, grade: 11, name: '오주현' },
                { no: 12, grade: 12, name: '김시온' },
                { no: 13, grade: 11, name: '조한' },
                { no: 14, grade: 11, name: '김용민' },
                { no: 15, grade: 11, name: '권문무' },
                { no: 16, grade: 11, name: '이세종' },
            ],
            남중: [
                { no: 1, grade: 9, name: '김이현' },
                { no: 2, grade: 9, name: '김동인' },
                { no: 3, grade: 9, name: '이유준' },
                { no: 4, grade: 9, name: '이도훈' },
                { no: 5, grade: 9, name: '김현성' },
                { no: 6, grade: 9, name: '구준표' },
                { no: 7, grade: 9, name: '조병준' },
                { no: 8, grade: 9, name: '권성현' },
                { no: 9, grade: 9, name: '구주찬' },
                { no: 10, grade: 9, name: '박찬민' },
                { no: 11, grade: 8, name: '안요셉' },
                { no: 12, grade: 8, name: '서주원' },
                { no: 13, grade: 7, name: '이태율' },
                { no: 14, grade: 7, name: '조아엘' },
                { no: 15, grade: 7, name: '양수현' },
                { no: 16, grade: 7, name: '김현욱' },
            ],
        },
        태권도: {
            태권체조: [
        ...
        탁구: {
            중등부: [
                { no: 1, grade: 9, name: '김예준', alt: '남' },
                { no: 2, grade: 9, name: '김유은', alt: '여' },
                { no: 3, grade: 9, name: '성제훈', alt: '남' },
                { no: 4, grade: 9, name: '손유향', alt: '여' },
            ],
            고등부: [
                { no: 1, grade: 12, name: '박근호', alt: '남' },
                { no: 2, grade: 12, name: '이희나', alt: '여' },
                { no: 3, grade: 11, name: '조승혁', alt: '남' },
                { no: 4, grade: 11, name: '한송연', alt: '여' },
            ],
            인기모: [
                { no: 1, name: '최가온(부)' },
                { no: 2, name: '김준수(모)' },
        ...
        이어달리기: {
            통합: [
                { label: '12학년' },
                { no: 1, grade: 12, name: '홍주원', alt: '남', role: '학생' },
                { no: 2, grade: 12, name: '황주하', alt: '여', role: '학생' },
                { label: '11학년' },
                { no: 3, grade: 11, name: '이정운', alt: '남', role: '학생' },
                { no: 4, grade: 11, name: '이다혜', alt: '여', role: '학생' },
                { label: '10학년' },
                { no: 5, grade: 10, name: '도연우', alt: '남', role: '학생' },
                { no: 6, grade: 10, name: '김세아', alt: '여', role: '학생' },
                { label: '9학년' },
                { no: 7, grade: 9, name: '김현성', alt: '남', role: '학생' },
                { no: 8, grade: 9, name: '이다빈', alt: '여', role: '학생' },
                { label: '8학년' },
                { no: 9, grade: 8, name: '안요셉', alt: '남', role: '학생' },
                { no: 10, grade: 8, name: '남궁두아', alt: '여', role: '학생' },
                { label: '7학년' },
                { no: 11, grade: 7, name: '김정헌', alt: '남', role: '학생' },
                { no: 12, grade: 7, name: '이예림', alt: '여', role: '학생' },
                { label: '인기모' },
                { no: 13, name: '이태율(부)', alt: '남', role: '인기모' },
                { no: 14, name: '이태율(모)', alt: '여', role: '인기모' },
                { label: '교직원' },
                { no: 15, name: '벤자민', alt: '남', role: '교직원' },
                { no: 16, name: '홍혜린', alt: '여', role: '교직원' },
                { label: '동문' },
                { no: 17, name: '현신웅', alt: '남', role: '동문' },
                { no: 18, name: '문진서', alt: '여', role: '동문' },
            ],
        },
    },
    세종: {
        ...
        배구: {
            남중: [
                ...
                { no: 4, grade: 9, name: 'Lucas Greivell' },
                { no: 5, grade: 9, name: '박지완' },
                { no: 6, grade: 9, name: 'Easton Socks' },
                { no: 7, grade: 9, name: 'Michael Snyder' },
                { no: 8, grade: 8, name: 'Mason Snyder' },
                { no: 9, grade: 7, name: '이나건' },
                { no: 10, grade: 7, name: '정은수' },
            ],
            남고: [
                ...
                { no: 5, grade: 10, name: 'Zachary Yanick' },
                { no: 6, grade: 10, name: 'Isaac Derr' },
                { no: 7, grade: 10, name: '정현수' },
                { no: 8, grade: 10, name: '최사무엘' },
                { no: 9, grade: 12, name: '김주한' },
                { no: 10, grade: 11, name: '박환상' },
            ],
            여연합: [
                { no: 1, grade: 11, name: '김하진' },
                { no: 2, grade: 10, name: 'Afton McClure' },
                { no: 3, grade: 9, name: 'Jiwoo Kim' },
                { no: 4, grade: 9, name: '이수아' },
                { no: 5, grade: 8, name: '강라엘' },
                { no: 6, grade: 7, name: '박향유' },
                { no: 7, grade: 9, name: '김영진' },
                { no: 8, grade: 10, name: '신지오' },
                { no: 9, grade: 11, name: '석지혜' },
                { no: 10, grade: 0, name: '' },
            ],
        },
        축구: {
            남고: [
                { no: 1, grade: 12, name: '김형민' },
                { no: 2, grade: 12, name: '손주환' },
                { no: 3, grade: 12, name: '김주한' },
                { no: 4, grade: 11, name: '박예환' },
                { no: 5, grade: 10, name: '정현수' },
                { no: 6, grade: 10, name: '김민후' },
                { no: 7, grade: 9, name: 'Mason' },
                { no: 8, grade: 9, name: 'Michael' },
                { no: 9, grade: 10, name: 'Isaac' },
                { no: 10, grade: 9, name: 'Easton' },
                { no: 11, grade: 9, name: '김루아' },
                { no: 12, grade: 8, name: 'Lucas' },
                { no: 13, grade: 8, name: 'Lachlan' },
                { no: 14, grade: 10, name: '김시온' },
                { no: 15, grade: 9, name: '임희수' },
            ],
        },
        태권도: {
            태권체조: [
        ...
        탁구: {
            중등부: [
                { no: 1, grade: 7, name: '정은수', alt: '남' },
                { no: 2, grade: 0, name: '이지호', alt: '남' },
                { no: 3, grade: 7, name: '박향유', alt: '여' },
            ],
            고등부: [
                { no: 1, grade: 10, name: '정현수', alt: '남' },
                { no: 2, grade: 10, name: '김민후', alt: '남' },
                { no: 3, grade: 10, name: '신지오', alt: '여' },
                { no: 4, grade: 10, name: '이주하', alt: '여' },
            ],
            인기모: [
                { no: 1, name: '정현수(부)' },
                { no: 2, name: '임은한(모)' },
        ...
        이어달리기: {
            통합: [
                { label: '12학년' },
                { no: 1, grade: 12, name: '김형민', alt: '남', role: '학생' },
                { no: 2, grade: 9, name: 'Jiwoo Kim', alt: '여', role: '학생' },
                { label: '11학년' },
                { no: 3, grade: 11, name: '박환상', alt: '남', role: '학생' },
                { no: 4, grade: 10, name: 'Afton McClure', alt: '여', role: '학생' },
                { label: '10학년' },
                { no: 5, grade: 10, name: '정현수', alt: '남', role: '학생' },
                { no: 6, grade: 10, name: '김하진', alt: '여', role: '학생' },
                { label: '9학년' },
                { no: 7, grade: 9, name: 'Michael Snyder', alt: '남', role: '학생' },
                { no: 8, grade: 8, name: '이예진', alt: '여', role: '학생' },
                { label: '8학년' },
                { no: 9, grade: 8, name: 'Mason Snyder', alt: '남', role: '학생' },
                { no: 10, grade: 8, name: '손은유', alt: '여', role: '학생' },
                { label: '7학년' },
                { no: 11, grade: 7, name: '이나건', alt: '남', role: '학생' },
                { no: 12, grade: 7, name: '박향유', alt: '여', role: '학생' },
                { label: '인기모' },
                { no: 13, name: '김주한(부)', alt: '남', role: '인기모' },
                { no: 14, name: '임은한(모)', alt: '여', role: '인기모' },
                { label: '교직원' },
                { no: 15, name: '방신영', alt: '남', role: '교직원' },
                { no: 16, name: '김인애', alt: '여', role: '교직원' },
                { label: '동문' },
                { no: 17, name: '박주홀', alt: '남', role: '동문' },
                { no: 18, name: '김한나', alt: '여', role: '동문' },
            ],
        },
    },
};
