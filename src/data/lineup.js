...
export const LINEUP = {
    ...
    음성: {
        ...
        탁구: {
            중등부: [
                { no: 1, grade: 9, name: '김예준' },
                { no: 2, grade: 9, name: '김유은' },
                { no: 3, grade: 9, name: '성제훈' },
                { no: 4, grade: 9, name: '손유향' },
            ],
            고등부: [
                { no: 1, grade: 12, name: '박근호' },
                { no: 2, grade: 12, name: '이희나' },
                { no: 3, grade: 11, name: '조승혁' },
                { no: 4, grade: 11, name: '한송연' },
            ],
            인기모: [
                { no: 1, name: '최완영' },
                { no: 2, name: '양명주' },
