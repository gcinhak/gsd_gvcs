...
export const LINEUP = {
    문경: {
        ...
        탁구: {
            ...
            인기모: [
                { no: 1, name: '양정수', alt: '9 이은혁 모' },
                { no: 2, name: '최용락', alt: '10 최규민 부' },
                {  no: 3, name: '홍성택', alt: '9 홍하일 부' },
                {  no: 4, name: '이성화', alt: '9 이은혁 부' },
            ],
            교직원: [{ no: 1, name: '이경민' }, {  no: 2, name: '남정하' }, { no: 3, name: '김경식' }, { name: '신찬영' }],
        },
        체스: {
    ...
    학생부: [
        ...
        { no: 2, grade: 8, name: '이선율' },
        { no: 3, grade: 8, name: '김지훈' },
        { no: 4, grade: 7, name: '주혜원' },
        { no: 5, grade: 8, name: '최민교' },
        { no: 6, grade: 9, name: '우도현' },
        { no: 7, grade: 9, name: '장서율' },
        { no: 8, grade: 9, name: '이래윤' },
        { no: 9, grade: 10, name: '배혜성' },
        { no: 10, grade: 10, name: '김성율' },
        { no: 11, grade: 10, name: '임환희' },
        { no: 12, grade: 10, name: '김나예' },
        { no: 13, grade: 11, name: '김영휘', alt: '축구' },
        { no: 14, grade: 11, name: '김하겸' },
        { no: 15, grade: 11, name: '박승민' },
        { no: 16, grade: 12, name: '강민성', alt: '축구' },
        { no: 17, grade: 12, name: '최지웅' },
        { no: 18, grade: 12, name: '김세빈' },
        { no: 19, grade: 12, name: '김가현' },
    ],
    인기모: [
        { no: 1, name: '박형렬', alt: '12 박하은 부' },
        { no: 2, name: '윤은정', alt: '8 강윤성 모' },
        { no: 3, name: '장보선', alt: '후보 · 7 김주아 모' },
    ],
},
        줄다리기: {
            학생팀: [
                { no: 1,grade: 8, name: '양하준' },
                { no: 1,grade: 7, name: '이윤재' },
                { no: 1,grade: 7, name: '홍준표' },
                { no: 1,grade: 9, name: '정인성' },
                { no: 1,grade: 8, name: '이선율' },
                { no: 1,grade: 9, name: '하성현' },
                { no: 1,grade: 9, name: '박준영' },
                { no: 1, grade: 7, name: '강은결' },
                { no: 1,grade: 8, name: '석지훈' },
                { no: 1,grade: 7, name: '정태이' },
                { no: 1, grade: 9, name: '김시원' },
                { no: 1,grade: 9, name: '김지현A' },
                { no: 1,grade: 8, name: '박예은' },
                { no: 1,grade: 8, name: '최민교' },
                { no: 1,grade: 8, name: '황서윤' },
                { no: 1,grade: 12, name: '송재현' },
                { no: 1, grade: 11, name: '주지원' },
                { no: 1, grade: 11, name: '이다솔' },
                { no: 1,grade: 11, name: '이이삭' },
                { no: 1,grade: 10, name: '이에녹' },
                { no: 1,grade: 10, name: '운유현' },
                { no: 1,grade: 10, name: '임승현' },
                { no: 1,grade: 12, name: '박예준' },
                { no: 1,grade: 10, name: '안현성' },
                { no: 1,grade: 11, name: '김선우' },
                { no: 1,grade: 10, name: '이지안' },
                { no: 1,grade: 12, name: 'Hanna' },
                { no: 1,grade: 11, name: '김나린' },
                { no: 1,grade: 10, name: '신라희' },
                { no: 1,grade: 10, name: '황라온' },
                { no: 1,grade: 8, name: '임주왕'},
                { no: 1,grade: 8, name: '표찬범'},
                { no: 1,grade: 9, name: '최규현'},
                { no: 1,grade: 12, name: '김동훈'},
                { no: 1,grade: 12, name: '강민성'},
                { no: 1,grade: 10, name: '최규민'},
                { no: 1,grade: 12, name: '권태연'},
                { no: 1,grade: 10, name: '김수빈'},
            ],
            성인팀: [
                ...
                { name: '마성주', role: '동문' },
                { name: '이희성', role: '동문' },
                { name: '하준호', role: '학부모', alt: '12 하지훈 부' },
                { name: '박해성', role: '교직원' },
                { name: '신호준', role: '교직원' },
                { name: '조현진', role: '교직원' },
                { name: '송대섭', role: '교직원' },
                { name: '11주지원 부', role: '학부모' },
                { name: '오은미', role: '학부모', alt: '10 오주하 모' },
                { name: '김미영', role: '교직원' },
                { name: '신선미', role: '교직원' },
                { name: '남정하', role: '교직원' },
                { name: '복미영', role: '교직원' },
                ...
                { name: '김유민', role: '교직원' },
                { name: '김예원', role: '교직원' },
                { name: '김하은', role: '교직원/동문' },
                { name: '이현지', role: '교직원/동문' },
            ],
        },
    },
    음성: {},
