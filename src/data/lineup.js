    ...
    문경: {
        ...
        탁구: {
            중등부: [
                ...
                { name: '조시온', alt: '후보' },
                { no: 2, grade: 9, name: '홍하일' },
                { name: '백종서', alt: '후보' },
            ],
            고등부: [
                { no: 1, grade: 11, name: '김은혜F' },
                { name: '이윤지', alt: '후보' },
                { no: 2, grade: 10, name: '이명준' },
                { name: '홍승현', alt: '후보' },
            ],
            인기모: [
            ...
            교직원: [{ no: 1, name: '이경민' }, { name: '남정하' }, { no: 2, name: '김경식' }, { name: '신찬영' }],
        },
        체스: {
            '7-8학년': [{ no: 1, grade: 8, name: '박주원' }, { name: '임온찬' }],
            '9-10학년': [{ no: 1, grade: 9, name: '변지원' }, { name: '윤종한' }],
            '11-12학년': [{ no: 1, grade: 11, name: '윤주호' }, { name: '정소망' }],
        },
        태권도: {
            태권체조: [
        ...
        중거리: {
            통합: [
                ...
                { grade: 10, name: '전준호' },
                { grade: 12, name: '강민성' },
                { grade: 12, name: '박예준', bench: true },
                { grade: 12, name: '권태연', bench: true },
            ],
        },
        이어달리기: {
            통합: [
                ...
                { grade: 10, name: '임환희' },
                { grade: 10, name: '김나예' },
                { grade: 11, name: '김영휘', alt: '축구' },
                { grade: 11, name: '김하겸' },
                { grade: 11, name: '박승민' },
                { grade: 12, name: '강민성', alt: '축구' },
                { grade: 12, name: '최지웅' },
                { grade: 12, name: '김세빈' },
                { grade: 12, name: '김가현' },
        ...
        줄다리기: {
            학생팀: [
                ...
                { grade: 10, name: '신라희' },
                { grade: 10, name: '황라온' },
                { grade: 8, name: '임주왕', bench: true },
                { grade: 8, name: '표찬범', bench: true },
                { grade: 9, name: '최규현', bench: true },
                { grade: 12, name: '김동훈', bench: true },
                { grade: 12, name: '강민성', bench: true },
                { grade: 10, name: '최규민', bench: true },
                { grade: 12, name: '권태연', bench: true },
