export const DASHBOARD_STORAGE_KEY = 'gvcs-dashboard-results-v1';
...
export const INITIAL_DASHBOARD_EVENTS = [
    {
        ...
        winnerKey: 'mungyeong',
        divisions: [
            { id: 'soccer-high-men', label: '고등부(남)', winnerKey: 'mungyeong', note: '후반 종료', state: 'done' },
            { id: 'soccer-mid-men', label: '중등부(남)', winnerKey: 'eumseong', note: '전반 진행', state: 'live' },
    ...
    },
    {
        ...
        winnerKey: 'sejong',
        divisions: [
            { id: 'basketball-high-men', label: '고등부(남)', winnerKey: 'sejong', note: '2Q 종료', state: 'done' },
            { id: 'basketball-mid-men', label: '중등부(남)', winnerKey: 'mungyeong', note: '집계 완료', state: 'done' },
            { id: 'basketball-mix-women', label: '중고연합(여)', winnerKey: 'pending', note: '대진 확인', state: 'ready' },
        ],
    },
    {
        id: 'volleyball',
        ...
        winnerKey: 'mungyeong',
        divisions: [
            { id: 'volleyball-high-men', label: '고등부(남)', winnerKey: 'mungyeong', note: '2세트 선취', state: 'live' },
            { id: 'volleyball-mid-men', label: '중등부(남)', winnerKey: 'eumseong', note: '결과 입력', state: 'done' },
            { id: 'volleyball-mix-women', label: '중고연합(여)', winnerKey: 'pending', note: '코트 배정', state: 'ready' },
        ],
    },
    {
        id: 'table-tennis',
        ...
        winnerKey: 'eumseong',
        divisions: [
            { id: 'table-high', label: '고등부', winnerKey: 'eumseong', note: '3세트 완료', state: 'done' },
            { id: 'table-mid', label: '중등부', winnerKey: 'mungyeong', note: '결과 입력', state: 'done' },
            { id: 'table-popular', label: '인기모', winnerKey: 'sejong', note: '진행 중', state: 'live' },
    ...
    },
    {
        ...
        winnerKey: 'pending',
        divisions: [
            { id: 'chess-7-8', label: '7-8학년', winnerKey: 'pending', note: '대진 확정', state: 'ready' },
            { id: 'chess-9-10', label: '9-10학년', winnerKey: 'pending', note: '대진 확정', state: 'ready' },
            { id: 'chess-11-12', label: '11-12학년', winnerKey: 'pending', note: '대진 확정', state: 'ready' },
        ],
    },
    {
        id: 'taekwondo',
        ...
        groups: [
            {
                ...
                title: '태권체조',
                divisions: [{ id: 'tk-routine', label: '태권체조', winnerKey: 'mungyeong', note: '점수 합산', state: 'done' }],
            },
            {
                id: 'taekwondo-poomsae',
                title: '품새',
                divisions: [
                    { id: 'tk-poomsae-mid', label: '품새(중)', winnerKey: 'eumseong', note: '결과 입력', state: 'done' },
                    { id: 'tk-poomsae-high', label: '품새(고)', winnerKey: 'mungyeong', note: '결과 입력', state: 'done' },
                ],
            },
            {
                ...
                title: '겨루기',
                divisions: [
                    { id: 'tk-sparring-mid', label: '겨루기(중)', winnerKey: 'sejong', note: '진행 중', state: 'live' },
    ...
    },
    {
        ...
        winnerKey: 'pending',
        divisions: [
            { id: 'distance-mid-women', label: '중등부(여)', winnerKey: 'pending', note: '기록 대기', state: 'ready' },
            { id: 'distance-mid-men', label: '중등부(남)', winnerKey: 'mungyeong', note: '기록 확정', state: 'done' },
            { id: 'distance-high-women', label: '고등부(여)', winnerKey: 'eumseong', note: '기록 확정', state: 'done' },
            { id: 'distance-high-men', label: '고등부(남)', winnerKey: 'pending', note: '출발 대기', state: 'live' },
        ],
    },
    {
        id: 'relay',
        ...
        status: '경기 대기',
        winnerKey: 'pending',
        divisions: [{ id: 'relay-main', label: '이어달리기', winnerKey: 'pending', note: '주자 명단 확인', state: 'ready' }],
    },
    {
        id: 'tug-of-war',
        sport: '줄다리기',
        ...
        winnerKey: 'eumseong',
        divisions: [
            { id: 'tug-students', label: '학생팀', winnerKey: 'eumseong', note: '2승', state: 'done' },
            { id: 'tug-adults', label: '성인팀', winnerKey: 'mungyeong', note: '1승 1패', state: 'live' },
        ],
    },
];
